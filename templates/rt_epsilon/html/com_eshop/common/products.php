			...
			<div class="clearfix">
                ...
                ?>            
					<div class="span<?php echo $span; ?> ajax_block_product spanbox clearfix">
                        ...
                        <div class="buttons">                            
                            <?php 
                            if (!EshopHelper::getConfigValue('catalog_mode') && !$product->product_call_for_price)
                            { ?>
                            	<div class="input-append">
									<?php if (EshopHelper::getConfigValue('show_quantity_box'))
                                    {
                                        ?>
                                            ...
                                            <span class="eshop-quantity">
                                                ...
                                                <input type="text" class="quantityvalue" id="quantity_<?php echo $product->id; ?>" name="quantity" value="1" />
                                    ...
                                    ?>
								<input id="add-to-cart-<?php echo $product->id; ?>" type="button" class="button" onclick="addToCart(<?php echo $product->id; ?>, 1, '<?php echo EshopHelper::getSiteUrl(); ?>');" value="<?php echo JText::_('ESHOP_ADD_TO_CART'); ?>" />
                                </div>
	                            <?php
                            }
