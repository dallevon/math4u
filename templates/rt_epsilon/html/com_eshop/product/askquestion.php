...
?>
<div class="row-fluid">
	<legend id="ask-question-title"><?php echo JText::_('ESHOP_ASK_QUESTION'); ?></legend>
	<div id="ask-question-area">
		<form method="post" name="adminForm" id="adminForm" action="index.php" class="form form-horizontal">
			...
			<input type="button" class="button pull-left" id="button-ask-question" value="<?php echo JText::_('ESHOP_SUBMIT'); ?>" />
	...
	Eshop.jQuery(function($){
		$('#button-ask-question').click(function(){
			...
			if (validated)
			{
				...
				$.ajax({
					type :'POST',
					url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=product.processAskQuestion',
