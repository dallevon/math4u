...
<div class="span6 no_margin_left">
	...
	?>
	<input type="button" class="button pull-left" id="button-account" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
<?php
if (EshopHelper::getCheckoutType() != 'guest_only')
{
	...
	<div id="login" class="span5">
		...
		<fieldset>
			...
			<input type="button" class="button pull-left" id="button-login" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
...
<script type="text/javascript">
	...
	Eshop.jQuery(document).ready(function($){
		...
		$('#button-account').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=' + $('input[name=\'account\']:checked').attr('value') + '&format=raw',
				dataType: 'html',
				beforeSend: function() {
