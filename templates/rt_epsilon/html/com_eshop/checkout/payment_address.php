...
<div class="no_margin_left">
	<input type="button" class="button pull-right" id="button-payment-address" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
<script type="text/javascript"><!--
	...
	Eshop.jQuery(function($){
		$('#button-payment-address').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.processPaymentAddress',
				type: 'post',
				...
				success: function(json) {
					...
					if (json['return']) {
						...
						?>
						$.ajax({
							url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=shipping_address&format=raw',
							dataType: 'html',
						...
						else
						{
							...
							{						
								$.ajax({
									url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=payment_method&format=raw',
									dataType: 'html',
									success: function(html) {
							...
							{
								$.ajax({
									url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=confirm&format=raw',
									dataType: 'html',
									success: function(html) {
						...
						?>					
						$.ajax({
							url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=payment_address&format=raw',
							dataType: 'html',
							success: function(html) {
