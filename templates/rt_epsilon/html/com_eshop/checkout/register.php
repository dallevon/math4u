...
<div class="no_margin_left">
	...
	?>
	<input type="button" class="button pull-right" id="button-register" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
...
<script type="text/javascript"><!--
	...
	Eshop.jQuery(function($){
		$('#button-register').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.register',
				type: 'post',
				...
				success: function(json) {
					...
					if (json['return']) {
						...
						?>				
							...
							if (shipping_address) {
								$.ajax({
									url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=shipping_method&format=raw',
									dataType: 'html',
