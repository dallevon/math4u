...
<div class="no_margin_left">
	<input type="button" class="button pull-right" id="button-guest" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
...
<!--
	Eshop.jQuery(document).ready(function($){
		...
		$('#button-guest').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.guest',
				type: 'post',
							...
							if (shipping_address) {
								$.ajax({
									...
									success: function(html) {
										...
										$.ajax({
											url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&view=checkout&layout=guest_shipping&format=raw',
											dataType: 'html',
											success: function(html) {
