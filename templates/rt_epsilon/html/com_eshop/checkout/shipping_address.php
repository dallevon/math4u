...
<div class="no_margin_left">
	<input type="button" class="button pull-right" id="button-shipping-address" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
<script type="text/javascript"><!--
	...
	Eshop.jQuery(function($){		
		$('#button-shipping-address').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.processShippingAddress',
				type: 'post',
