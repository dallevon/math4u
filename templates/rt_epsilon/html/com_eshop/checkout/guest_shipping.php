...
<div class="no_margin_left">
	<input type="button" class="button pull-right" id="button-guest-shipping" value="<?php echo JText::_('ESHOP_CONTINUE'); ?>" />
</div>
<script type="text/javascript"><!--
	Eshop.jQuery(document).ready(function($){
		...
		$('#button-guest-shipping').click(function(){
			$.ajax({
				url: '<?php echo EshopHelper::getSiteUrl(); ?>index.php?option=com_eshop&task=checkout.processGuestShipping',
				type: 'post',
