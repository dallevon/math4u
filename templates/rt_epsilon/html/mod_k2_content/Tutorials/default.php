...
$k2itemid = JRequest::getVar('id');

$k2itemid = explode(':', $k2itemid);
...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="tutorials">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; if($item->id == $k2itemid) echo ' active'; ?>">
      ...
      <small><?php echo JText::_('K2_IN') ; ?> <?php echo $item->categoryname; ?></small>
      ...
      <?php if($params->get('itemAttachments') && count($item->attachments)): ?>
			...
			<div class="moduleAttachments">
				...
				<a title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>" href="<?php echo $attachment->link; ?>" class="readon"><?php echo $attachment->title; ?></a>
